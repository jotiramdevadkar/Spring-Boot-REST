...
public class UserController {
	...
	public ResponseEntity<Void> createUser(@RequestBody User user, UriComponentsBuilder usBuilder){
		System.out.println("Creating User "+user.getName());
		userService.createUser(user);
		
		HttpHeaders headers=new HttpHeaders();
		headers.setLocation(usBuilder.path("/user/{id}").buildAndExpand(user.getId()).toUri());
